...
CESM/CIME is used directly from its source code. Researches will clone some release or development version of CESM, grab additional sources for CIME in external repos and use that ensemble to create, build and run simulations (*aka* cases). Therefore, providing static releases of this software in our HPC clusters is of limited interest. This repo contains all files and tools developed by VUB-HPC to make the source code of CESM work in our clusters and which are provided to our users of CESM/CIME.
